...
int32_t __android_log_get_minimum_priority(void) __attribute__((weak)) { return 0; }
int32_t __android_log_set_minimum_priority(int32_t) __attribute__((weak)) { return 0; }
...
void __android_log_logd_logger(const struct __android_log_message*) __attribute__((weak)) {
    tag = log_message->tag ? string(log_message->tag) : default_tag;
...
void __android_log_write_log_message(struct __android_log_message* log_message) __attribute__((weak)) {
