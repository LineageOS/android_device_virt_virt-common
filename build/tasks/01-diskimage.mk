...
ifeq ($(AB_OTA_UPDATER),true)
    ...
    DISK_VDA_PARTITION_VENDOR_BOOT_A_START_SECTOR := 25792512
    DISK_VDA_PARTITION_VENDOR_BOOT_B_START_SECTOR := 25997312
    DISK_VDA_PARTITION_BOOT_A_START_SECTOR := 26202112
    DISK_VDA_PARTITION_BOOT_B_START_SECTOR := 26365952
    DISK_VDA_PARTITION_BIOS_START_SECTOR := 26529792
    DISK_VDA_PARTITION_BIOS_A_START_SECTOR := $(DISK_VDA_PARTITION_BIOS_START_SECTOR)
    DISK_VDA_PARTITION_BIOS_B_START_SECTOR := $(DISK_VDA_PARTITION_BIOS_START_SECTOR)
    ...
    DISK_VDA_PARTITION_VENDOR_BOOT_A_SECTORS := 204800
    DISK_VDA_PARTITION_VENDOR_BOOT_B_SECTORS := 204800
    DISK_VDA_PARTITION_BOOT_A_SECTORS := 163840
    DISK_VDA_PARTITION_BOOT_B_SECTORS := 163840
    DISK_VDA_PARTITION_BIOS_SECTORS := 8192
    DISK_VDA_PARTITION_BIOS_A_SECTORS := $(DISK_VDA_PARTITION_BIOS_SECTORS)
    DISK_VDA_PARTITION_BIOS_B_SECTORS := $(DISK_VDA_PARTITION_BIOS_SECTORS)
    ...
    ifeq ($(BOARD_SUPER_PARTITION_SIZE),3221225472)
        ...
        DISK_VDA_PARTITION_BIOS_START_SECTOR := 7544832
        DISK_VDA_PARTITION_VENDOR_BOOT_START_SECTOR := 7553024
        ...
        DISK_VDA_PARTITION_PERSIST_SECTORS := 32768
        DISK_VDA_PARTITION_BIOS_SECTORS := 8192
        DISK_VDA_PARTITION_VENDOR_BOOT_SECTORS := 204800
    else ifeq ($(BOARD_SUPER_PARTITION_SIZE),4294967296)
        DISK_VDA_SECTORS := 10485760
        DISK_VDA_PARTITION_EFI_START_SECTOR := 2048
        DISK_VDA_PARTITION_SUPER_START_SECTOR := 526336
        DISK_VDA_PARTITION_MISC_START_SECTOR := 8914944
        DISK_VDA_PARTITION_METADATA_START_SECTOR := 8916992
        DISK_VDA_PARTITION_CACHE_START_SECTOR := 8982528
        DISK_VDA_PARTITION_BOOT_START_SECTOR := 9084928
        DISK_VDA_PARTITION_RECOVERY_START_SECTOR := 9216000
        DISK_VDA_PARTITION_FIRMWARE_START_SECTOR := 9347072
        DISK_VDA_PARTITION_PERSIST_START_SECTOR := 9609216
        DISK_VDA_PARTITION_BIOS_START_SECTOR := 9641984
        DISK_VDA_PARTITION_VENDOR_BOOT_START_SECTOR := 9650176
        DISK_VDA_PARTITION_EFI_SECTORS := 524288
...
DISK_VDA_WRITE_PARTITIONS += BIOS
INSTALLED_DISKIMAGE_VDA_TARGET_DEPS += $(INSTALLED_MBRIMAGE_TARGET)
endif
endif
