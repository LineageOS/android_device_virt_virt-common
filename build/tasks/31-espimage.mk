...
$(INSTALLED_ESPIMAGE_TARGET): $(INSTALLED_ESPIMAGE_TARGET_DEPS) $(HOST_OUT_EXECUTABLES)/mtools
	$(hide) mkdir -p $(dir $@)
...
$(INSTALLED_ESPIMAGE_INSTALL_TARGET): $(INSTALLED_ESPIMAGE_INSTALL_TARGET_DEPS) $(HOST_OUT_EXECUTABLES)/mtools
