...
BOOTMGR_SHARED_LIBS_DIR := prebuilts/bootmgr/lib64
BOOTMGR_TOOLS_BIN_DIR := prebuilts/bootmgr/tools/$(HOST_PREBUILT_TAG)/bin
BOOTMGR_TOOLS_ENV := LD_LIBRARY_PATH=$(BOOTMGR_SHARED_LIBS_DIR) PATH=$(BOOTMGR_TOOLS_BIN_DIR):$$PATH
BOOTMGR_XORRISO_EXEC := $(BOOTMGR_TOOLS_ENV) $(BOOTMGR_TOOLS_BIN_DIR)/xorriso
...
define process-bootmgr-cfg-common
	...
	sed -i "s|@LINUX_SERIAL_DEVICE@|$(BOARD_LINUX_SERIAL_DEVICE)|g" $(1)
	...
	$(if $(filter true,$(TARGET_MESA_ENABLE_SOFTWARE_RENDERER)),
