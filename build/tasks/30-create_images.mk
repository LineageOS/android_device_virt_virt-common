...
define create-fat32image
	...
	$(BOOTMGR_TOOLS_64_EXEC_ENV) $(BOOTMGR_TOOLS_BIN_DIR)/mformat -F -i $(1) -v "$(3)" ::
	$(foreach content,$(2),$(BOOTMGR_TOOLS_64_EXEC_ENV) $(BOOTMGR_TOOLS_BIN_DIR)/mcopy -i $(1) -s $(content) :: &&)true
endef
