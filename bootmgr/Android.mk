...
INSTALLED_PERSISTIMAGE_GZ_TARGET := $(TARGET_OUT_INTERMEDIATES)/CUSTOM_IMAGES/persist.img.gz
...
$(INSTALLED_ESPIMAGE_TARGET): $(INSTALLED_ESPIMAGE_TARGET_DEPS)
	$(hide) mkdir -p $(dir $@)
	$(call make-espimage-target,$(INSTALLED_ESPIMAGE_TARGET),$(INSTALLED_ESPIMAGE_INSTALL_TARGET_INCLUDE_FILES))
...
$(INSTALLED_PERSISTIMAGE_GZ_TARGET): $(INSTALLED_PERSISTIMAGE_TARGET)
	cat $(INSTALLED_PERSISTIMAGE_TARGET) | gzip > $@

include $(CLEAR_VARS)
LOCAL_MODULE := persist_img_gz_recovery
LOCAL_MODULE_STEM := persist.img.gz
LOCAL_MODULE_CLASS := DATA
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_PATH := $(PRODUCT_OUT)/recovery/root/system/etc
LOCAL_PREBUILT_MODULE_FILE := $(INSTALLED_PERSISTIMAGE_GZ_TARGET)
