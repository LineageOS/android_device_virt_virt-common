...
ifeq ($(TARGET_GRUB_ARCH),x86_64-efi)
	...
	ifeq ($(TARGET_GRUB_EFI_PREGENERATED),)
		$(error Please specify pre-generated GRUB EFI file)
	endif
endif
...
define make-espimage
	...
	if [ "$(TARGET_GRUB_EFI_PREGENERATED)" ]; then \
		cp $(TARGET_GRUB_EFI_PREGENERATED) $(3)/fsroot/EFI/BOOT/$(BOOTMGR_EFI_BOOT_FILENAME); \
	else \
